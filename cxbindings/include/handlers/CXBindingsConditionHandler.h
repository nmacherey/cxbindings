 ...
 * @version 10.4
 */
#ifndef CXBINDINGSCONDITIONHANDLER_H
#define CXBINDINGSCONDITIONHANDLER_H

/**
  * @class CXBindingsConditionHandler
  * @brief Main class for building a condition from an xml node
  * 
  * @author Nicolas Macherey (nicolas.macherey@gmail.com)
  * @date 8-May-2010
  */
class CXBindingsConditionHandler : public CXBindingsXmlHandler
{
	DECLARE_ABSTRACT_CLASS_CXBINDINGS(CXBindingsConditionHandler)
	
public :
	/** Default constructor */
	CXBindingsConditionHandler();
