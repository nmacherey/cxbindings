/**
 * @file CXBindingsHandler.h
 * @brief main file for defining grammar  handler for a node
 * @author Nicolas Macherey (nicolas.macherey@gmail.com)
 * @version 10.4
 */
#ifndef CXBINDINGSGRAMMARHANDLER_H
#define CXBINDINGSGRAMMARHANDLER_H

/**
  * @class CXBindingsHandler
  * @brief Main class for building a  from an xml node
  * 
  * @author Nicolas Macherey (nicolas.macherey@gmail.com)
  * @date 8-May-2010
  */
class CXBindingsHandler : public CXBindingsXmlHandler
{
	DECLARE_ABSTRACT_CLASS_CXBINDINGS(CXBindingsHandler)
