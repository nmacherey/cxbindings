/**
 * @file CXBindingsObjectHandler.h
 * @brief main file for defining grammar object handler for a node
 * @author Nicolas Macherey (nicolas.macherey@gmail.com)
 * @version 10.4
 */
#ifndef CXBINDINGSOBJECTHANDLER_H
#define CXBINDINGSOBJECTHANDLER_H

/**
  * @class CXBindingsObjectHandler
  * @brief Main class for building a object from an xml node
  * 
  * @author Nicolas Macherey (nicolas.macherey@gmail.com)
  * @date 8-May-2010
  */
class CXBindingsObjectHandler : public CXBindingsXmlHandler
{
	DECLARE_ABSTRACT_CLASS_CXBINDINGS(CXBindingsObjectHandler)
	
public :
	/** Default constructor */
	CXBindingsObjectHandler();
