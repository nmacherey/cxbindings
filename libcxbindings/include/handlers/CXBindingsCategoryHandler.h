/**
 * @file CXBindingsCategoryHandler.h
 * @brief main file for defining grammar category handler for a node
 * @author Nicolas Macherey (nicolas.macherey@gmail.com)
 * @version 10.4
 */
#ifndef CXBINDINGSCATEGORYHANDLER_H
#define CXBINDINGSCATEGORYHANDLER_H

/**
  * @class CXBindingsCategoryHandler
  * @brief Main class for building a category from an xml node
  * 
  * @author Nicolas Macherey (nicolas.macherey@gmail.com)
  * @date 8-May-2010
  */
class CXBindingsCategoryHandler : public CXBindingsXmlHandler
{
	DECLARE_ABSTRACT_CLASS_CXBINDINGS(CXBindingsCategoryHandler)
	
public :
	/** Default constructor */
	CXBindingsCategoryHandler();
