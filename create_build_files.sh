...
#build codelite
$PREMAKE_DIR/bin/premake --target cl-gcc $unicode $debug $wxver
echo done...
echo
fi
...
#build codeblocks
$PREMAKE_DIR/bin/premake --target cb-gcc $unicode $debug $wxver
echo done...
echo
fi
...
#build makefile
$PREMAKE_DIR/bin/premake --target gnu $unicode $debug $wxver
echo done...
echo
fi
#
